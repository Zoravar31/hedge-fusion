...
ALL_TOOLS      = DATA_TOOL_DEFINITIONS + EXECUTION_TOOL_DEFINITIONS
ALL_TOOL_MAP   = {**DATA_TOOL_MAP, **EXECUTION_TOOL_MAP}
DATA_ONLY_MAP  = DATA_TOOL_MAP
...
def run_sentiment_analyst(ticker: str) -> dict:
    raw = run_agent(
        ...
        user_message=(
            ...
            f"Fetch recent news and bulk/block deal data."
        ),
        tools=DATA_TOOL_DEFINITIONS,
        tool_map=DATA_ONLY_MAP,
    )
